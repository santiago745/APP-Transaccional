...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([correspondingIndexPath subRow] == 0)
    {
        ...
        if (expandableCell.isExpandable)
        {
            ...
            if ([expandableButton respondsToSelector:@selector(addTarget:action:forControlEvents:)]) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
        ...
        if (cell.isExpandable)
        {
            ...
            if (_indexPath)
            {
                ...
                if (cell.isExpanded)
                {
                    ...
                    cell.contentView.backgroundColor = OM_COLOR_CELL_SELECTION_GREEN;
    ...
    else
    {
        if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:didSelectSubRowAtIndexPath:)])
        {
            ...
            if (_current)
            {
               [_cellPrevious setHighlighted:NO animated:NO];
            }
